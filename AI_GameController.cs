...
public class GameController : MonoBehaviour
{
	...
	private AIController aiController; // AIController referansı
	...
	{
		// AI'den sonraki soruyu al
		Question currentQuestion = aiController.GetNextQuestion(correctAnswers);
